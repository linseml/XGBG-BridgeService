...
dependencies {
    implementation 'com.github.linseml:XGBG-BridgeService:1.0.15'
}
```
...
| `XPopupCenter<VM, VB>` | CenterPopupView | 居中弹窗 |
...
- `mViewModel: VM` — 自动 ViewModel
- `onSetup()` — 子类初始化抽象方法
- `setPopupLifecycleListener()` — 可选生命周期回调
...
- JitPack 发布：`com.github.linseml:XGBG-BridgeService:1.0.15`
